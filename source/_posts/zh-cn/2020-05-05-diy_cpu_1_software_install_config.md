...
随着近几年RISC-V开源指令集逐渐在学术和工业界得到认可，个人设计CPU已经不再是遥不可及的事情，再加上自己最近被胡振波老师的**《教你设计CPU—RISC-V处理器》**这本书中的内容所深深吸引，于是我决定重启**自制CPU项目**。当然，因为我目前只能算是一个初学者，所以如果接下来的文章中有哪些内容写得有误，欢迎各位大佬指正！
