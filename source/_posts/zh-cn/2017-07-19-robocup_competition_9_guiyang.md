...
随着RoboCup合肥国际赛的结束，我们晓萌队又开始紧锣密鼓地着手准备10月份的RoboCup中国赛。由于之前5月份我们在中国服务机器人大赛上的惨痛失利，所以我们这一次根据新的比赛规则提前制定了详细的开发计划，并且由队长组织每周五晚上要开一次例会，内容涉及每个队员对各自所负责模块的开发进度的阐述以及对开发过程中所遇问题的论等。
