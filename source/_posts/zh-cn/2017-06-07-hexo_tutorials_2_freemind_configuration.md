...
![disqus_login_and_signup](http://media.myyerrol.io/images/hexo/disqus/disqus_login_and_signup.png)
...
![disqus_get_started](http://media.myyerrol.io/images/hexo/disqus/disqus_get_started.png)

选择**I want to install Disqus on my site**选项后，接着会出现下面的界面：

![disqus_create_site](http://media.myyerrol.io/images/hexo/disqus/disqus_create_site.png)
...
![disqus_configuration](http://media.myyerrol.io/images/hexo/disqus/disqus_configuration.png)
