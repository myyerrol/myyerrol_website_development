...
![breeze_hardware_architecture](https://media.myyerrol.io/images/breeze_quadcopter/1_hardware_design/breeze_hardware_architecture.png)
...
![kicad_logo](https://media.myyerrol.io/images/breeze_quadcopter/1_hardware_design/logo_kicad.png)
...
- #### 成果
  ...
  ![breeze_pcb_kicad](https://media.myyerrol.io/images/breeze_quadcopter/1_hardware_design/breeze_pcb_kicad.png)

### Altium Designer

![altium_logo](https://media.myyerrol.io/images/breeze_quadcopter/1_hardware_design/logo_altium.jpg)
...
- #### 成果
  ...
  ![breeze_pcb_altium](https://media.myyerrol.io/images/breeze_quadcopter/1_hardware_design/breeze_pcb_altium.png)

### Cadence SPB

![cadence_logo](https://media.myyerrol.io/images/breeze_quadcopter/1_hardware_design/logo_cadence.jpg)
...
- #### 原理
  ...
  ![breeze_motor](https://media.myyerrol.io/images/breeze_quadcopter/1_hardware_design/breeze_motor.png)
...
- #### 原理
  ...
  ![breeze_power_battery](https://media.myyerrol.io/images/breeze_quadcopter/1_hardware_design/breeze_power_battery.png)
  ...
  ![breeze_power_nuf2221w1t2](https://media.myyerrol.io/images/breeze_quadcopter/1_hardware_design/breeze_power_nuf2221w1t2.png)

  NUF2221W1T2在电路中的作用主要是对USB进行缓冲或保护，防止因为USB的错误导致电路系统出现意外情况。

  ![breeze_power_max16054](https://media.myyerrol.io/images/breeze_quadcopter/1_hardware_design/breeze_power_max16054.png)
  ...
  ![breeze_power_bq24075](https://media.myyerrol.io/images/breeze_quadcopter/1_hardware_design/breeze_power_bq24075.png)

  BQ24075 充电时的参数可以通过连接不同阻值大小的电阻来确定，以下是具体的计算公式：

  **快速充电电流（ISET）**
  ![breeze_formula_1](https://media.myyerrol.io/images/breeze_quadcopter/1_hardware_design/breeze_formula_1.jpg)

  **输入电流限制（ILIM）**
  ![breeze_formula_2](https://media.myyerrol.io/images/breeze_quadcopter/1_hardware_design/breeze_formula_2.jpg)

  **快速充电安全定时器（TMR）**
  ![breeze_formula_3](https://media.myyerrol.io/images/breeze_quadcopter/1_hardware_design/breeze_formula_3.jpg)

  根据以上官方提供的公式和电路图中的电阻阻值，可以得出此时BQ24075的快速充电电流为740mA，输入电流限制为1.3A，安全定时器为80min左右。

  ![breeze_power_tps79301_vcca](https://media.myyerrol.io/images/breeze_quadcopter/1_hardware_design/breeze_power_tps79301_vcca.png)

  ![breeze_power_tps79301_vcc](https://media.myyerrol.io/images/breeze_quadcopter/1_hardware_design/breeze_power_tps79301_vcc.png)

  ![breeze_power_tps79301_guide](https://media.myyerrol.io/images/breeze_quadcopter/1_hardware_design/breeze_power_tps79301_guide.png)

  TPS79301可调输出的稳压值可以通过以下计算公式得到：
  ![breeze_formula_4](https://media.myyerrol.io/images/breeze_quadcopter/1_hardware_design/breeze_formula_4.jpg)
...
- #### 原理
  ...
  ![breeze_sensor_mpu6050](https://media.myyerrol.io/images/breeze_quadcopter/1_hardware_design/breeze_sensor_mpu6050.png)

  ![breeze_sensor_hmc5883l](https://media.myyerrol.io/images/breeze_quadcopter/1_hardware_design/breeze_sensor_hmc5883l.png)

  ![breeze_sensor_ms5611](https://media.myyerrol.io/images/breeze_quadcopter/1_hardware_design/breeze_sensor_ms5611.png)
...
- #### 原理
  ...
  ![breeze_wireless](https://media.myyerrol.io/images/breeze_quadcopter/1_hardware_design/breeze_wireless.png)

  ![breeze_wireless_guide](https://media.myyerrol.io/images/breeze_quadcopter/1_hardware_design/breeze_wireless_guide.png)
...
- #### 原理
  ...
  ![breeze_controller_stm32f103t6u6](https://media.myyerrol.io/images/breeze_quadcopter/1_hardware_design/breeze_controller_stm32f103t6u6.png)
  ...
  ![breeze_table](https://media.myyerrol.io/images/breeze_quadcopter/1_hardware_design/breeze_table.png)
  ...
  ![breeze_controller_cp2102](https://media.myyerrol.io/images/breeze_quadcopter/1_hardware_design/breeze_controller_cp2102.png)

  CP2102电路原理比较简单，它负责转换USB和RS232接口的电平，主要用于后期的代码调试中。

  ![breeze_controller_expansion](https://media.myyerrol.io/images/breeze_quadcopter/1_hardware_design/breeze_controller_expansion.png)
