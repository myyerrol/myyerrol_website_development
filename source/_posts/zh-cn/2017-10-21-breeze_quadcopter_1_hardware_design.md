...
![kicad_logo](http://media.myyerrol.io/images/breeze/hardware/logo_kicad.png)
...
- #### 成果
  ...
  ![breeze_pcb_kicad](http://media.myyerrol.io/images/breeze/hardware/breeze_pcb_kicad.png)

### Altium Designer

![altium_logo](http://media.myyerrol.io/images/breeze/hardware/logo_altium.jpg)
...
- #### 成果
  ...
  ![breeze_pcb_altium](http://media.myyerrol.io/images/breeze/hardware/breeze_pcb_altium.png)

### Cadence SPB

![cadence_logo](http://media.myyerrol.io/images/breeze/hardware/logo_cadence.jpg)
...
- #### 原理
  ...
  ![breeze_motor](http://media.myyerrol.io/images/breeze/hardware/breeze_motor.png)
...
- #### 原理
  ...
  ![breeze_power_battery](http://media.myyerrol.io/images/breeze/hardware/breeze_power_battery.png)
  ...
  ![breeze_power_nuf2221w1t2](http://media.myyerrol.io/images/breeze/hardware/breeze_power_nuf2221w1t2.png)

  NUF2221W1T2在电路中的作用主要是对USB进行缓冲或保护，防止因为USB的错误导致电路系统出现意外情况。

  ![breeze_power_max16054](http://media.myyerrol.io/images/breeze/hardware/breeze_power_max16054.png)
  ...
  ![breeze_power_bq24075](http://media.myyerrol.io/images/breeze/hardware/breeze_power_bq24075.png)

  BQ24075 充电时的参数可以通过连接不同阻值大小的电阻来确定，以下是具体的计算公式：

  **快速充电电流（ISET）**
  ![breeze_formula_1](http://media.myyerrol.io/images/breeze/hardware/breeze_formula_1.jpg)

  **输入电流限制（ILIM）**
  ![breeze_formula_2](http://media.myyerrol.io/images/breeze/hardware/breeze_formula_2.jpg)

  **快速充电安全定时器（TMR）**
  ![breeze_formula_3](http://media.myyerrol.io/images/breeze/hardware/breeze_formula_3.jpg)

  根据以上官方提供的公式和电路图中的电阻阻值，可以得出此时BQ24075的快速充电电流为740mA，输入电流限制为1.3A，安全定时器为80min左右。

  ![breeze_power_tps79301_vcca](http://media.myyerrol.io/images/breeze/hardware/breeze_power_tps79301_vcca.png)

  ![breeze_power_tps79301_vcc](http://media.myyerrol.io/images/breeze/hardware/breeze_power_tps79301_vcc.png)

  ![breeze_power_tps79301_guide](http://media.myyerrol.io/images/breeze/hardware/breeze_power_tps79301_guide.png)

  TPS79301可调输出的稳压值可以通过以下计算公式得到：
  ![breeze_formula_4](http://media.myyerrol.io/images/breeze/hardware/breeze_formula_4.jpg)
...
- #### 原理
  ...
  ![breeze_sensor_mpu6050](http://media.myyerrol.io/images/breeze/hardware/breeze_sensor_mpu6050.png)

  ![breeze_sensor_hmc5883l](http://media.myyerrol.io/images/breeze/hardware/breeze_sensor_hmc5883l.png)

  ![breeze_sensor_ms5611](http://media.myyerrol.io/images/breeze/hardware/breeze_sensor_ms5611.png)
...
- #### 原理
  ...
  ![breeze_wireless](http://media.myyerrol.io/images/breeze/hardware/breeze_wireless.png)

  ![breeze_wireless_guide](http://media.myyerrol.io/images/breeze/hardware/breeze_wireless_guide.png)
...
- #### 原理
  ...
  ![breeze_controller_stm32f103t6u6](http://media.myyerrol.io/images/breeze/hardware/breeze_controller_stm32f103t6u6.png)
  ...
  ![breeze_table](http://media.myyerrol.io/images/breeze/hardware/breeze_table.png)
  ...
  ![breeze_controller_cp2102](http://media.myyerrol.io/images/breeze/hardware/breeze_controller_cp2102.png)

  CP2102电路原理比较简单，它负责转换USB和RS232接口的电平，主要用于后期的代码调试中。

  ![breeze_controller_expansion](http://media.myyerrol.io/images/breeze/hardware/breeze_controller_expansion.png)
