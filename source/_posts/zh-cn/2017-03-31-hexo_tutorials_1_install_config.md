...
- 登录GitHub并点击**Setting**选项。
  ...
  ![github_settings](https://media.myyerrol.io/images/hexo_tutorials/1_install_config/github_settings.png)

- 使用文本编辑器打开`.ssh`文件夹下的`id_rsa.pub`文件，将里面的内容添加到你的GitHub账户设置中的**SSH Key**中去。

  ![github_ssh_keys](https://media.myyerrol.io/images/hexo_tutorials/1_install_config/github_ssh_keys.png)
...
- 登录你的GitHub，点击**New repository**。
  ...
  ![github_new_repository](https://media.myyerrol.io/images/hexo_tutorials/1_install_config/github_new_repository.png)

- 填写仓库的名字和相关描述。

  ![github_create_repository](https://media.myyerrol.io/images/hexo_tutorials/1_install_config/github_create_repository.png)
